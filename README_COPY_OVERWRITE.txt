...
6. Open GitHub Desktop, review the changes, commit, and Push origin.

Do not copy the enclosing release folder itself into the repository. Copy its CONTENTS.
...
- Visual reserve entry points, edges, edge portions, and polygon zones on the Deployment Editor map.
- Deployment Undo/Redo plus Cancel/Escape for interactive tools.
- Schema 1.1.0 hierarchy compatibility while retaining full scenario/map/deployment portability.
