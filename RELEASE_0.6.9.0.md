# Battle Axe Design Studio v0.6.9.0
...
- v0.6.9.0 adds release-owned regression coverage for both friendly and unintended-enemy intervening units between a charger and its declared target.
...
- The v0.6.9.0 playtest worker cache-busts the worker URL so the upgraded tactical engine is not accidentally bypassed by a cached v0.6.8.1 worker.
...
- application of the v0.6.9.0 tactical engine transform to the v0.6.8.1 baseline;
