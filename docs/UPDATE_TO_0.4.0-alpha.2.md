...
5. Commit with: `Battle Axe Design Studio v0.4.0-alpha.2 map and deployment alpha`
6. Push origin.
7. Wait for the GitHub Actions deployment to turn green.
8. Hard-refresh the live site and confirm the header reports `v0.4.0-alpha.2`.
