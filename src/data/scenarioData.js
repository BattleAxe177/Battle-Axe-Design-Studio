export const UNIT_LIBRARY = [
  ...
  {profile:'Baggage Train',category:'Army Asset',icon:'▣',m:0,c:0,a:0,pts:4,traits:['Immobile','Army Asset','Baggage Train'],armies:['French','Italian','Imperial','Spanish','Tudor'],source:'Italian Wars Supplement — Camp / Baggage rules',baseMm:40,asset:true},
