import { loadState, saveState, createInitialState, STORAGE_KEY } from './app/state.js?v=0.6.0.0';
import { setupNavigation, setupBattlefieldSubnav } from './modules/navigation.js?v=0.6.0.0';
import { setupFeatureReview } from './modules/featureReview.js?v=0.6.0.0';
import { setupGeometryExplorer } from './modules/geometryExplorer.js?v=0.6.0.0';
import { loadInlineMap, loadInlineMapText } from './modules/mapView.js?v=0.6.0.0';
import { detectBattlefieldFeatures } from './modules/battlefieldDetector.js?v=0.6.0.0';
import { loadStructuredTerrainManifest, inspectPptxAuthoring, compilePptxTerrain, manifestStats, classSummary } from './modules/structuredMapCompiler.js?v=0.6.0.0';
import { setupScenarioBuilder } from './modules/scenarioBuilder.js?v=0.6.0.0';
import { setupDeploymentEditor } from './modules/deploymentEditor.js?v=0.6.0.0';
import { setupPlaytestCenter } from './modules/playtestCenter.js?v=0.6.0.0';
import { setupAiBridge } from './modules/aiBridge.js?v=0.6.0.0';
import { setupScenarioPublisher } from './modules/scenarioPublisher.js?v=0.6.0.0';
import { newBattlefieldRevision, applyPlayAreaViewBox, serializeBattlefieldSvg, invalidateBattlefieldDependents, syncBattlefieldImages } from './modules/battlefieldState.js?v=0.6.0.0';
...
function setupSampleProjectLoader(){
  $('#loadPaviaSample')?.addEventListener('click',async()=>{
    try{
      const mod=await import('./samples/paviaSample.js?v=0.6.0.0');
