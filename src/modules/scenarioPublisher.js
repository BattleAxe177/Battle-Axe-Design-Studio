...
import { battlefieldImageUrl } from './battlefieldState.js?v=0.6.8.0';
import { sideLabel } from './scenarioSides.js?v=0.6.8.0';
import { footprintPercentFromSpec } from './footprintGeometry.js?v=0.6.8.0';
