import { getEffectiveRuleset } from '../rules/ruleset.js?v=0.6.0.3';
import { battlefieldImageUrl } from './battlefieldState.js?v=0.6.0.3';
import { sideLabel } from './scenarioSides.js?v=0.6.0.3';
