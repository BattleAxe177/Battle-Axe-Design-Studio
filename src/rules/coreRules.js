export const CORE_RULESET = Object.freeze({
  ...
  baseGeometry:{unitBaseMm:50,unitBaseWidthMm:50,unitBaseDepthMm:50,commanderBaseMm:25},
  movement:{moveWheelMaxDegrees:90,chargeWheelMaxDegrees:45,enemyExclusionInches:1,backwardSidewaysFraction:.5},
  command:{commandRangeInches:3,generalRangeInches:4,commanderMoveInches:4,commanderEnemyExclusionInches:1,escapeThreshold:4,commanderVictoryPoints:2,generalVictoryPoints:3,cannotBeShot:true,chargeOnlyIfNearestVisible:true,hierarchicalAuthority:true,authorityRule:'A commander may affect only units in that command or descendant commands.'},
