export const AMERICAN_CIVIL_WAR_SUPPLEMENT = Object.freeze({
  ...
  aiDoctrine:{
    ...
    summary:'Fight the brigade; maneuver the regiments. Preserve brigade frontage and flanks, prefer sustained fire over unsupported frontal charges, use sharpshooters as a screen, support attacks with artillery, and use cavalry mobility before committing it to close combat.',
    brigadeCentric:true,
