...
function chargeState(){return{project:{playSpace:{width:48,height:48,units:'inches'},features:[],scenario:{metadata:{title:'Charge',gameLength:1},suggestions:[],sourceCommands:[],sourceForces:[],unresolved:[],victoryText:'',historicalSituation:'',commands:{sideA:[{id:'cf',name:'sideA',commander:'',units:[{id:'f',name:'Gendarmes',profile:'Gendarmes',traits:['Shock Cavalry']}]}],sideB:[{id:'ci',name:'sideB',commander:'',units:[{id:'i',name:'Spanish Arquebusiers',profile:'Arquebusiers',traits:['Arquebus']}]}],Garrison:[]},deployment:{placements:{f:{x:40,y:50,faction:'sideA',commandId:'cf',facing:90},i:{x:52,y:53,faction:'sideB',commandId:'ci',facing:270}},commanderPlacements:{},zones:[]}}},decisions:{}};}
