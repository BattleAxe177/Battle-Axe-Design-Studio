...
test('battlefield review hides detector metrics behind technical details',()=>{assert.match(feature,/Technical details/);assert.match(feature,/function confidenceLabel\(/);assert.match(feature,/function friendlySource\(/);});
